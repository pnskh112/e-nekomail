...
#  browser = Watir::Browser.new :chrome, profile: profile
 ...
 # browser.window(:title => "新規送信 - IMAGE WORKS SECURE DELIVER").use do
    ...
    # 添付ファイル
    browser.file_field( :id => "fileSelect").set(send_file) if browser.div(:id => "fileListDisplayArea").present?
    ...
    # 送信ボタン押下
    aTag = searchATag3Id(browser,"dialogForm:j_idt2268:j_idt2278:buttonId","dialogForm:j_idt1914:j_idt1922:buttonId","dialogForm:j_idt1917:j_idt1925:buttonId")
    aTag.click
    ...
    # 送信完了のメッセージが出るのでOKボタンを押下
    browser.alert.ok if browser.alert.exists?

    # Closeボタン押下
    aTag = searchATag(browser,"form:j_idt473:j_idt569:j_idt570:buttonId","form:j_idt473:j_idt569:j_idt570:buttonId")
    aTag.click
